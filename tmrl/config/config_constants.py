...
PRAGMA_RL2 = TMRL_CONFIG.get("PRAGMA_RL2", False)  # True to use the recurrent (Transformer-trunk) RL² stack
RL2_BURN_IN = TMRL_CONFIG.get("RL2_BURN_IN", 20)
RL2_TRAIN_WINDOW = TMRL_CONFIG.get("RL2_TRAIN_WINDOW", 64)
RL2_TRANSFORMER_D_MODEL = TMRL_CONFIG.get("RL2_TRANSFORMER_D_MODEL", 64)
RL2_TRANSFORMER_LAYERS = TMRL_CONFIG.get("RL2_TRANSFORMER_LAYERS", 2)
RL2_TRANSFORMER_HEADS = TMRL_CONFIG.get("RL2_TRANSFORMER_HEADS", 2)
RL2_TRANSFORMER_FFN = TMRL_CONFIG.get("RL2_TRANSFORMER_FFN", 128)
RL2_TRANSFORMER_MAX_LEN = TMRL_CONFIG.get("RL2_TRANSFORMER_MAX_LEN", 128)
RL2_TASK_CONDITIONING = TMRL_CONFIG.get("RL2_TASK_CONDITIONING", False)
RL2_TASK_NUM_TASKS = TMRL_CONFIG.get("RL2_TASK_NUM_TASKS", 1)
RL2_TASK_Z_DIM = TMRL_CONFIG.get("RL2_TASK_Z_DIM", 8)
RL2_TASK_LOSS_COEF = TMRL_CONFIG.get("RL2_TASK_LOSS_COEF", 0.05)
